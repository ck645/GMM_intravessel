...
png(filename = "./Figures/Figure8b_1.png", width = 2400, height = 1600, res=300)
...
png(filename = "./Figures/Figure8b_2.png", width = 2400, height = 1600, res=300)
...
png(filename = "./Figures/Figure8a_1.png", width = 1350, height = 1000, res=300)
plot(Roundness)
dev.off()
...
png(filename = "./Figures/Figure8a_2.png", width = 1350, height = 1000, res=300)
plot(Circ)
dev.off()
...
welch_distance <- oneway.test(Group_distance_to_centroid ~ ware, data = wall_thickness, var.equal = FALSE)
welch_circ <- oneway.test(circ ~ ware, data = wall_thickness, var.equal = FALSE)
welch_round <- oneway.test(Round ~ ware, data = wall_thickness, var.equal = FALSE)
welch_CVhwall <- oneway.test(CV_horizontal_wall_thickness ~ ware, data = wall_thickness, var.equal = FALSE)

print(welch_distance$p.value)
print(welch_circ$p.value)
print(welch_round$p.value)
print(welch_CVhwall$p.value)
...
png(filename = "./Figures/Table 4/group_distance_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/Circ_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/Round_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/CVhthickness_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/distance_range_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/mhthickness_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/Circ_range_density_plot.png", width = 1600, height = 1200, res=300)
...
png(filename = "./Figures/Table 4/Round_range_density_plot.png", width = 1600, height = 1200, res=300)
