...
single_tpsdata <- Momocs::import_tps("./Data/single_cross_section.TPS")
single_database <- rio::import("./Data/single_cross_section.csv")
...
tpsdata <- Momocs::import_tps("./Data/intravessel30.TPS")
database <- rio::import("./Data/intravessel30_db.csv")
